...
def unstrand_line_by_size(args):
    ...
    ax[0].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
    ...
    ax[1].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
    ...
    ax[2].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
    ...
    ax[3].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
    ...
    ax[4].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
...
def strand_line_by_size(args):
    ...
    ax[0].plot(x, mean_signal_bc_all_f, color='red', label='Forward')
    ax[0].plot(x, mean_signal_bc_all_r, color='green', label='Reverse')
    ax[0].xaxis.set_ticks_position('bottom')
    ax[0].yaxis.set_ticks_position('left')
    ax[0].spines['top'].set_visible(False)
    ax[0].spines['right'].set_visible(False)
    ax[0].spines['left'].set_position(('outward', 15))
    ax[0].tick_params(direction='out')
    ax[0].set_title(args.output_prefix + " all ", fontweight='bold')
    ax[0].set_xticks([start, 0, end])
    ax[0].set_xticklabels([str(start), 0, str(end)])
    ax[0].set_yticks([min_signal, max_signal])
    ax[0].set_yticklabels([str(round(min_signal, 3)), str(round(max_signal, 3))], rotation=90)
    ...
    ax[1].plot(x, mean_signal_bc_Nfr_f, color='red', label='Forward')
    ax[1].plot(x, mean_signal_bc_Nfr_r, color='green', label='Reverse')
    ax[1].xaxis.set_ticks_position('bottom')
    ax[1].yaxis.set_ticks_position('left')
    ax[1].spines['top'].set_visible(False)
    ax[1].spines['right'].set_visible(False)
    ...
    ax[2].plot(x, mean_signal_bc_1N_f, color='red', label='Forward')
    ax[2].plot(x, mean_signal_bc_1N_r, color='green', label='Reverse')
    ax[2].xaxis.set_ticks_position('bottom')
    ax[2].yaxis.set_ticks_position('left')
    ax[2].spines['top'].set_visible(False)
    ax[2].spines['right'].set_visible(False)
    ...
    ax[3].plot(x, mean_signal_bc_1N_plus_f, color='red', label='Forward')
    ax[3].plot(x, mean_signal_bc_1N_plus_r, color='green', label='Reverse')
    ax[3].xaxis.set_ticks_position('bottom')
    ax[3].yaxis.set_ticks_position('left')
    ax[3].spines['top'].set_visible(False)
    ax[3].spines['right'].set_visible(False)
    ...
    ax[4].plot(x, mean_signal_bc_2N_f, color='red', label='Forward')
    ax[4].plot(x, mean_signal_bc_2N_r, color='green', label='Reverse')
    ax[4].xaxis.set_ticks_position('bottom')
    ax[4].yaxis.set_ticks_position('left')
    ax[4].spines['top'].set_visible(False)
    ax[4].spines['right'].set_visible(False)
